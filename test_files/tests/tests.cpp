...
void checkUnit(std::shared_ptr<EnemyUnit> unit, Vector position, sf::Color color, double shape_size){
...
BOOST_AUTO_TEST_CASE(circleStrongEnemyUnit){
...
BOOST_AUTO_TEST_CASE(squareStrongEnemyUnit){
